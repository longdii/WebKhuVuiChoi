...
<head>
    ...
    <link rel="stylesheet" href="/Public/Css/TrangChuNguoiDung.css">
    <link rel="stylesheet" href="/Public/Css/fonts/themify-icons/themify-icons.css">
    <style>
    #muave>a::before {
        content: url(/Public/Images/ticke.png);
...
<body>
        ...
        <div class="header-bottom">
            ...
            <div class="sub-right">
                <ul>
                    ...
                    <li id="muave"><a href="/Muave_c">Mua Vé</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="footer"
        style="background: url(/Public/Images/bg-footer.png);background-size: cover;">
        <div class="footer-top">
            <div class="logo"><img src="/Public/Images/logo_halong.png" alt=""></div>
            <div class="left">
                <ul>
