...
<head>
    ...
    <link rel="stylesheet" href="/Public/Css/TrangChuCaNhan.css">
...
<body>
        ...
        <div class="container">
                    ...
                    <ul id="sub-menu">
                        <li>
                            <div class="content" style="border-bottom: 0.1px dashed rgb(209, 209, 209);height: 60px;">
                                <img src="/Public/Images/logo_halong.png" alt="">
                                <div><p>Trang Chu</p></div>
                            </div>
                        </li>
                        <li>
                            <div class="content">
                                <div><img src="/Public/Images/site-2.jpg" alt=""></div>
                            <div><p>Asia Park</p></div>
                            </div>
                        </li>
                        <li>
                            <div class="content">
                                <img src="/Public/Images/DJI_0971-1.jpg" alt="">
                                <p>Ba Na Hills</p>
                            </div>
                        </li>
                        <li>
                            <div class="content">
                                <img src="/Public/Images/site-1.jpg" alt="">
                                <p>Ba Den Mountain</p>
                            </div>
                        </li>
                        <li>
                            <div class="content">
                                <img src="/Public/Images/site2.jpg" alt="">
                                <p>Hon Thom</p>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            <div class="content">
                                <img src="/Public/Images/001.jpg" alt="">
                                <p>Fansipan Legend</p>
                            </div>
                        </li>
                        <li>
                            <div class="content">
                                <img src="/Public/Images/277674793_507229567554731_3483001761365827116_n.jpg" alt="">
                                <p>Cat Ba</p>
                            </div>
                        </li>
                        <li>
                            <div class="content">
                                <img src="/Public/Images/KTS-1.jpg" alt="">
                                <p>Kiss The Stars</p>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="logo">
                <img src="/Public/Images/logo_hanglong2.png" alt="">
            </div>
        </div>
        <div class="right">
            <div class="Name">
            ...
            <div class="ngonngu">
                    <img id="VN" src="/Public/Images/vietnam.png" alt="" onclick="ngongufunction()">
                <div id="EN">
                    <img src="/Public/Images/en.png" alt="" onclick="ngonngufunction()">
    ...
    <div class="aside">
        ...
        <div class="footer">
                <div class="footer-top">
                    ...
                    <div class="form-icon">
                        <img src="/Public/Images/ic12.png" alt="">
                        <img src="/Public/Images/ic14.png" alt="">
                    </div>
                </div>
