        ...
        <div class="container">
            ...
            <table class="content__table">
                ...
                <tr>
                    ...
                    <td>
                        <div class="img"
                            style="background-image: url(/Public/images/captreo_img/<?php echo $row['AnhCapTreo'] ?>);">
                        </div>
                    </td>
                    ...
                    <td>
                        <a
                            href="/CapTreoNuHoang_admin_c/xoa/<?php echo $row['MaCapTreo'] ?>"><i
                                class="content__table-icon fa-solid fa-trash"></i></a>
                        &nbsp;&nbsp;&nbsp;
                        <a
                            href="/CapTreoNuHoang_admin_c/sua/<?php echo $row['MaCapTreo'] ?>"><i
