            ...
            <div class="grid wide">
                ...
                <div class="row">
                    ...
                    ?>
                            <div class="col l-3">
                                <div class="ticket">
                                    <div class="ticket__img" style="background-image: url(/Public/images/ve_img/<?php echo $row['AnhVe'] ?>);">
                                    </div>
                ...
                <div class="ticket__footer">
                    <div class="ticket__footer-img0">
                        <div class="ticket__footer-img" style="background-image: url(/Public/images/ve_img/footer1.jpg);">
                        </div>
                    </div>

                    <div class="ticket__footer-img1">
                        <div class="ticket__footer-img1-1">
                            <div class="ticket__footer-img" style="margin-right: 10px; background-image: url(/Public/images/ve_img/footer3.jpg);">
                            </div>
                            <div class="ticket__footer-img" style="background-image: url(/Public/images/ve_img/footer2.jpeg);">
                            </div>
                        </div>

                        <div class="ticket__footer-img1-2">
                            <div class="ticket__footer-img" style="margin-right: 10px; background-image: url(/Public/images/ve_img/footer5.jpeg);">
                            </div>
                            <div class="ticket__footer-img" style="background-image: url(/Public/images/ve_img/footer4.jpeg);">
                            </div>
                        </div>
                    </div>
                </div>
