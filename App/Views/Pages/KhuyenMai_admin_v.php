...
<head>
    ...
    <link rel="stylesheet"
        href="/Public/Css/fonts/fontawesome-free-6.4.2-web/css/all.min.css">
    <link rel="stylesheet" href="/Public/Css/base.css">
    <link rel="stylesheet" href="/Public/Css/grid.css">
    <link rel="stylesheet" href="/Public/Css/reponsive.css">
    <link rel="stylesheet" href="/Public/Css/ve.css">
...
<body>
    <form action="/TinKhuyenMai_admin/timkiem" method="post">
        <div class="header">
        ...
        <div class="container">
            ...
            <table class="content__table">
                ...
                <tr>
                    ...
                    <td>
                        <div class="img"
                            style="background-image: url(/Public/Images/<?php echo $row['AnhVe'] ?>);">
                        </div>
                    </td>
                    <td><?php echo $row['TieuDe'] ?></td>
                    <td><div class="summarize"><?php echo $row['MoTa'] ?></div></td>
                    <td>
                        <a href="/TinKhuyenMai_admin/xoa/<?php echo $row['ID'] ?>"><i
                                class="content__table-icon fa-solid fa-trash"></i></a>
                        &nbsp;&nbsp;&nbsp;
                        <a href="/TinKhuyenMai_admin/sua/<?php echo $row['ID'] ?>"><i
