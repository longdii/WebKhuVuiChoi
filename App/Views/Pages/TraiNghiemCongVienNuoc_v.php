...
<head>
    ...
    <link rel="stylesheet" href="/Public/Css/TraiNghiemCongVienNuoc.css">
        ...
        <div  style="text-align: center" class="next-congviennuoc">
           <a href="">Trang Chủ</a ><i class="ti-angle-right"></i>
            ...
            <div id="sub-trainghiem" class="sub-trainghiem">
               <a href="/TraiNghiemCongVienRong">+ Công Viên Rồng</a>
               ...
               <a href="/TraiNghiemCapTreoNuHoang">+ Cáp Treo Nữ Hoàng Và Khu Đồi Huyền Bí</a>
            </div>
...
<?php
    ...
    <div class="col l-3">
        <div class="content_hop">
             <a href="">
           <div class="noidungcongviennuoc-img"><img src="/Public/Images/<?php echo $row['AnhVe']?>"></div>
