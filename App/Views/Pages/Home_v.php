...
<head>
    ...
    <link rel="stylesheet" href="/Public/Css/themify-icons/themify-icons.css">
                    ...
                    ?>
                            <div class="form-group">
                                <a href="#" class="sub-form-group">
                                    <img src="/Public/Images/<?php echo $row['AnhVe'] ?>" alt="">
                                    <div class="title">
        ...
        <div class="content2">
            <div class="sub-content2">
                <div class="bando-content">
                    ...
                    <a href=""><img src="/Public/Images/Screen-Shot-2018-10-18-at-12.43.02.png" alt=""></a>
                </div>
