...
<head>
    ...
    <link rel="stylesheet" href="/Public/Css/ThongTinTaiKhoan.css">
...
<div class="doashbox">
            <div class="sub-doashbox">
                <div class="form-doashbox" id="thongtintaikhoan">
                    <i class="ti-user"></i>
                    <a href="/thongtintaikhoan">Thông Tin Tài Khoản</a>
                </div>
                <div class="form-doashbox" id="quanlydonhang">
                    <i class="ti-shopping-cart"></i>
                <a href="/quanlydonhangcrl">Quản Lý Đơn Hàng</a>
                </div>
            ...
            <p class="title1">Một số thông tin cá nhân sẽ được sử dụng phục vụ mục đích đặt vé</p>
                <div class="sub-noidung">
                    ...
                    <div class="form-group">
                        ...
                        <a id="xemve" href="/TrangChuNguoiDung">Xem Vé</a>
