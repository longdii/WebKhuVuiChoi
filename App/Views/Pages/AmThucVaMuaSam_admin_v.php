...
<style>
    ...
    border-radius: 50%; /* Làm cho các góc tròn */
}
</style>
        ...
        <div class="container">
            ...
            <table class="content__table">
                ...
                <tr>
                    ...
                    <td>
                        <div class="img"
                            style="background-image: url(/Public/images/captreo_img/<?php echo $row['AnhAmThuc'] ?>);">
                        </div>
                    </td>
                    ...
                    <td>
                        <a
                            href="/AmThucVaMuaSam_admin_c/xoa/<?php echo $row['MaAmThuc'] ?>"><i
                                class="content__table-icon fa-solid fa-trash"></i></a>
                        &nbsp;&nbsp;&nbsp;
                        <a
                            href="/AmThucVaMuaSam_admin_c/sua/<?php echo $row['MaAmThuc'] ?>"><i
