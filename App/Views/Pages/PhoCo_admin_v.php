...
<body>
    <!-- /Ve_c/timkiem -->
    <form action="/PhoCo_admin_c/timkiem" method="post">
        <div class="header">
        ...
        <div class="container">
            ...
            <table class="content__table">
                ...
                <tr>
                    ...
                    <td>
                        <div class="img"
                            style="background-image: url(/Public/images/captreo_img/<?php echo $row['AnhPhoCo'] ?>);">
                        </div>
                    </td>
                    <td><?php echo $row['TenPhoCo'] ?></td>
                    <td><div class="summarize"><?php echo $row['MoTaPhoCo'] ?></div></td>
                    <td>
                        <a href="/PhoCo_admin_c/xoa/<?php echo $row['MaPhoCo'] ?>"><i
                                class="content__table-icon fa-solid fa-trash"></i></a>
                        &nbsp;&nbsp;&nbsp;
                        <a href="/PhoCo_admin_c/sua/<?php echo $row['MaPhoCo'] ?>"><i
