...
<body>
    <form action="/TraiNghiemCongVienRong_admin/timkiem" method="post">
        <div class="header">
        ...
        <div class="container">
            ...
            <table class="content__table">
                ...
                <tr>
                    ...
                    <td>
                        <a
                            href="/TraiNghiemCongVienRong_admin/xoa/<?php echo $row['ID'] ?>"><i
                                class="content__table-icon fa-solid fa-trash"></i></a>
                        &nbsp;&nbsp;&nbsp;
                        <a
                            href="/TraiNghiemCongVienRong_admin/sua/<?php echo $row['ID'] ?>"><i
