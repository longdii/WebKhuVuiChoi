...
<body>
    <form action="/Ve_c/timkiem" method="post">
        <div class="header">
        ...
        <div class="container">
            ...
            <table class="content__table">
                ...
                <tr>
                    ...
                    <td>
                        <div class="img"
                            style="background-image: url(/Public/images/ve_img/<?php echo $row['AnhVe'] ?>);">
                        </div>
                    </td>
                    <td><div class="summarize"><?php echo $row['TenVe'] ?></div></td>
                    <td><?php echo $row['GiaVe'] ?>đ</td>
                    <td>
                        <a href="/Ve_c/xoa/<?php echo $row['MaVe'] ?>"><i
                                class="content__table-icon fa-solid fa-trash"></i></a>
                        &nbsp;&nbsp;&nbsp;
                        <a href="/Ve_c/sua/<?php echo $row['MaVe'] ?>"><i
