...
<head>
    ...
    <link rel="stylesheet" href="/Public/Css/TraiNghiemPhoCo.css">
            ...
            <div class="row">
                ...
                ?>
                    ...
                    <div class="content_pc_hop">
                        ...
                        <div class="content_img_pc" style="background-image: url(/Public/Images/captreo_img/<?php echo $row['AnhPhoCo']?>);" ></div>   
                    </div>
                </div>
                <?php            
                        }
